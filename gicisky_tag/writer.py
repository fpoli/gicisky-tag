...
class ScreenWriter:
    ...
    def __init__(self, device, image):
        ...
        self.request_answered = None
        self.transfer_completion = asyncio.Event()
    ...
    async def _send_request(self, data):
        ...
        self.request_answered = asyncio.Event()
        request_answered = self.request_answered
    ...
    async def wait_transfer_completion(self):
        await self.transfer_completion.wait()
...
async def send_data_to_screen(address, image_data):
    ...
    async with BleakClient(address) as device:
        ...
        await screen.wait_transfer_completion()
